    ...
    [{compile_env,
         [{countdownplus,
              ...
              {ok,#{default_page_size => 100,max_page_size => 500,
                    max_records => 10000}}}]},
     {applications,
         [kernel,stdlib,elixir,logger,runtime_tools,bamboo,bamboo_ses,
          bcrypt_elixir,dataloader,ecto_autoslug_field,ecto_enum,
          ecto_soft_delete,ecto_network,ecto_sql,emojix,ex_aws,ex_aws_s3,
          ex_aws_ses,ex_cldr,ex_cldr_territories,excal,geo_postgis,imgproxy,
          inflex,jason,mjml,new_relic_agent,oban,oban_pro,phoenix_pubsub,
          plug_crypto,postgrex,slugify,timex,trans,tzdata]},
     ...
     {modules,
         ['Elixir.Countdownplus','Elixir.Countdownplus.Accounts',
          ...
          'Elixir.Countdownplus.Market.Policy',
