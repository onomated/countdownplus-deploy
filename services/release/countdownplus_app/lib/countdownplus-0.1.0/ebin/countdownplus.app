    ...
    [{compile_env,
     ...
     {applications,
         [kernel,stdlib,elixir,logger,runtime_tools,bamboo,bamboo_ses,
          ...
          ex_aws_ses,ex_cldr,ex_cldr_territories,excal,geo_postgis,inflex,
          jason,mjml,new_relic_agent,oban,oban_pro,phoenix_pubsub,plug_crypto,
          postgrex,slugify,timex,trans,tzdata]},
