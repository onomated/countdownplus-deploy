...
__webpack_require__(47168);

__webpack_require__(27124);
...
var _imageConfig = __webpack_require__(78028);
...
function Image(_param) {
  ...
  if (layout === 'fill') {
    ...
    if (layout === 'responsive') {
      ...
      hasSizer = true;
      sizerStyle.maxWidth = '100%'; // url encoded svg is a little bit shorten than base64 encoding
